...
public class TreeJudgeOps {
	...
	public boolean treeJudgeOps(binary_tree tree1, binary_tree tree2) {
	...
	//子树序列化(先序)
	public String subTreePreOrderSequence(binary_tree tree) {
	...
	//子树序列化(中序)
	public String subTreeInOrderSequence(binary_tree tree) {
