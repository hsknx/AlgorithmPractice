...
public class BTFindCertainValuePathTest extends BinaryTreeTestDemo {
    ...
    ArrayList<ArrayList<Integer>> all_list_Demo;
    ArrayList<Integer> list_Demo;
    int[] ValuePath;
    ...
    public void TestFindPath() {
        ...
        ValuePath = list_Demo.stream().mapToInt(Integer::intValue).toArray();
        ...
        BinaryTreeImpl b = ab.createBinaryTree(treeDemo060);
    ...
    public void TestFindPathStack() {
        ...
        ValuePath = list_Demo.stream().mapToInt(Integer::intValue).toArray();
        assert Arrays.equals(ValuePath, Demo031Result);
        list_Demo = bt.FindPathStack(gettreeDemo03(), Demo032).get(0);
        ValuePath = list_Demo.stream().mapToInt(Integer::intValue).toArray();
        assert Arrays.equals(ValuePath, Demo032Result);
